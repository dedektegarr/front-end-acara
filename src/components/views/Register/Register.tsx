      ...
      <Card>
        <CardBody className="flex flex-col w-full gap-3 p-8">
          <div>
            ...
            <p>
              Have an account?&nbsp;
              <Link href="/login" className="text-danger-500 font-semibold">
                Login here
              </Link>
            </p>
          </div>
          <form action="" className="flex flex-col w-full sm:w-80 gap-3">
            <Input variant="bordered" type="text" placeholder="Fullname" />
            <Input variant="bordered" type="text" placeholder="Username" />
